package experiments;
/*
bash KissCluster/create_cluster.sh Experiments_N100_W10_AKG_OCBA_AOCBA us-east-2 "java -server -Xmx1500M -cp lib/*:bin experiments.Experiments_N100_W50_AKG_OCBA_AOCBA" app/ s3://szufel-sim-ohio
*/
